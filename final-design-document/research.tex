...
\url{dietpi-software} utilities.

Packer will also be used to copy the \url{/boot/} modifications required to turn the
device into a USB gadget, as described in section \ref{sec:midi_peripheral}.
